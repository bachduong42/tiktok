...
function Header() {
    ...
    return (
        <div className=" w-full h-[60px] flex border-header">
            <div div className="w-full h-full flex flex-row justify-between text-center items-center px-[16px] pr-[24px]" >
                ...
                <div className="flex gap-5 items-center justify-center">
                    ...
                    <div className="group relative">
                        <MdIcon.MdOutlineMarkUnreadChatAlt className="text-[30px] text-[#494a4e] cursor-pointer" />
                        <span className="tooltip-text text-[13px] ">Hộp thư</span>
                    </div>
                    {/* <Tippy content="Hộp thư" placement="right"><MdIcon.MdOutlineMarkUnreadChatAlt className="text-[30px] text-[#494a4e] cursor-pointer" /></Tippy> */}
