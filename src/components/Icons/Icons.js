...
export const UnLikeIcon = ({ width = '21px', height = '19px', color }) => (
    <svg
        ...
        <g clip-path="url(#HeartFill_clip0)"><g filter="url(#HeartFill_filter0_d)">
            ...
            <path fill-rule="evenodd" clip-rule="evenodd" d="M2.40179 12.1998C3.58902 14.6966 5.7592 16.9269 7.74989 18.75C9.5504 20.3989 10.9999 21.5 11.9999 21.5C12.9999 21.5 14.4094 20.4072 16.2499
...
export const CommentIcon = ({ width = '21px', height = '19px', color }) => (
    <svg
        xmlns="http://www.w3.org/2000/svg" width={width} height={height} fill="currentColor">
        <use href="#Bubble_Ellipsis_Right_Fill-7ce6d3b3"></use></svg>
);